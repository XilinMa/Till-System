...
// deal with response from server but no refresh
...
// deal with response from server in details
...
// show refund, num, shift label, total_value
...
// // send page number and action = page.php
// function pos_page(id)
// {
//     console.log('reset_value', setReset);
//     pos_reset();
...
// show all the items (append new item after 'target')
...
// send page number and action = status
...
// clear receipt box and set title to 'Till System'
function pos_reset()
{
    var e;
    if (setReset == 1)
...
// send plu command and 'ins' value
...
// send item position and 'ins' value
...
// send refund, type and cash amount
function pos_cash(n)
{
    var e,c,r;
    pos_reset();
...
// set setNUM value and clear 'ins' value
function pos_num()
{
    var e;
    pos_reset();
...
// set 'ins' value to total purchase amount
function pos_total()
{
    var e;
    pos_reset();
